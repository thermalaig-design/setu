...
//
// A white-label tenant PWA is installed from /<slug> (see TenantLanding.jsx /
// TenantContext.jsx) and keeps running from that same origin. On this host,
// bare '/' belongs to the separate marketing website, not the member app —
// so once installed, any in-app "Home" action must return to /<slug>
// instead of '/', or the installed PWA will appear to open the marketing
// site. In a normal (non-standalone) browser tab, Home is unaffected and
// still resolves to '/'.
...
// - Installed/standalone PWA with a valid installed_app_slug -> '/<slug>'
